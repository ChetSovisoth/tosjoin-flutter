                ...
                children: [
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          SizedBox(
                            width:
                                halfScreenSize, // Set a consistent width for alignment
                            child: Row(
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    const Text("Location"),
                                    Text(EventDetailController.location,
                            ...
                            child: Row(
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    const Text("Date"),
                                    Text(EventDetailController.date,
                                        style: AppStyles.detailsTextStyle),
                                  ],
                                ),
                              ],
                            ...
                            child: Row(
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    const Text("Timing"),
                                    Text(EventDetailController.timing,
                                        style: AppStyles.detailsTextStyle),
                                  ],
                                ),
                              ],
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(EventDetailController.attendance,
                                        style: AppStyles.detailsTextStyle),
                                  ],
                                ),
                              ],
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      ...EventDetailController.descriptions
                          .map((text) => Text(text)),
                      ...EventDetailController.descriptions
                          .map((text) => Text(text)),
                      ...EventDetailController.descriptions
