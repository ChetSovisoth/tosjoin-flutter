...
class AppStyles {
  ...
  static TextStyle detailsTextStyle =
      TextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: blueColor);
  ...
  static TextStyle agendaTitleTextStyle = TextStyle(
      fontSize: 18, fontWeight: FontWeight.w600, color: progressColor);

  static TextStyle agendaDescriptionTextStyle =
      const TextStyle(fontSize: 15, color: Color.fromRGBO(84, 95, 113, 1));
}
